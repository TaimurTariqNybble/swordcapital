                        ...
                        <div className="col-lg-10">
                            <div className="row justify-content-center">
                                <div className="col-lg-4 col-md-6 col-sm-6">
                                    ...
                                    <Link to="/open-accounts/personal-account" className="account-btn"> فتح الحسابات &nbsp; <img className="hov" src={BtnIcon2} alt=""/> </Link>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-md-6 col-sm-6">
                                    ...
                                    <Link to="/open-accounts/premium-account" className="account-btn"> فتح الحسابات &nbsp; <img className="hov" src={BtnIcon2} alt=""/> </Link>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-md-6 col-sm-6">
                                    <div className="card-box" data-aos="fade-up" data-aos-duration="500" data-aos-delay="150">
                                    ...
                                    <Link to="/open-accounts/corporate-acc" className="account-btn"> فتح الحسابات &nbsp; <img className="hov" src={BtnIcon2} alt=""/> </Link>
                                    </div>
                                </div>
                            </div>
                        </div>
